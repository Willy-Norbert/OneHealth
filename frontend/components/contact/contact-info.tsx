    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">{t("contactInfo.heading")}</h2>
          <p className="text-gray-600">{t("contactInfo.description")}</p>
        </div>
        ...
        <div className="max-w-3xl mx-auto mt-12 bg-red-50 border border-red-200 rounded-xl p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-bold text-gray-900 mb-2">{t("contactInfo.emergency.title")}</h3>
              <p className="text-gray-700 mb-2">{t("contactInfo.emergency.desc")}</p>
              <p className="text-red-600 font-bold">{t("contactInfo.emergency.hotline")}</p>
            </div>
          </div>
        </div>
      </div>
