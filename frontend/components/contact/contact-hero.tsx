      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-600 max-w-xl">{t("contactHero.description")}</p>
            <div className="flex flex-wrap gap-4 pt-4">
              <div className="flex items-center bg-green-50 px-4 py-2 rounded-full">
                <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                <span className="text-green-800 font-medium">{t("contactHero.badge1")}</span>
              </div>
              <div className="flex items-center bg-blue-50 px-4 py-2 rounded-full">
                <div className="w-3 h-3 bg-blue-500 rounded-full mr-2"></div>
                <span className="text-blue-800 font-medium">{t("contactHero.badge2")}</span>
              </div>
            </div>
          </div>
