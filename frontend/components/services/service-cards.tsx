    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900">{t("services2.title")}</h2>
          <p className="text-gray-600 mt-2 max-w-2xl mx-auto">{t("services2.subtitle")}</p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">{t("services2.ai.title")}</h3>
              <p className="text-gray-600 mb-6">{t("services2.ai.desc")}</p>
