      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-gray-600 mb-8">{t("emergency.description")}</p>
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8">
              <h3 className="font-bold text-gray-900 mb-4">{t("emergency.types_label")}</h3>
            ...
            <div className="relative z-10">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-white p-4 rounded-xl shadow-lg flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm">{t("emergency.overlay.ambulance_title")}</h4>
                    <p className="text-gray-500 text-xs">{t("emergency.overlay.ambulance_sub")}</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-4 right-4 bg-white p-4 rounded-xl shadow-lg flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm">{t("emergency.overlay.medical_guidance_title")}</h4>
                    <p className="text-gray-500 text-xs">{t("emergency.overlay.medical_guidance_sub")}</p>
                  </div>
                </div>
                ...
                <div className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white p-4 rounded-xl shadow-lg flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm">{t("emergency.overlay.gps_title")}</h4>
                    <p className="text-gray-500 text-xs">{t("emergency.overlay.gps_sub")}</p>
                  </div>
                </div>
              </div>
            </div>
