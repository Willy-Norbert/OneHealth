        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Schedule Care On <span className="text-green-600">Your Terms</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-xl">
              Book appointments with healthcare providers at your convenience. Find and schedule visits with the right
              specialists, choose between in-person or virtual consultations.
            </p>
            ...
            <div className="relative mt-8">
              ...
              />
              <Button className="absolute right-1.5 top-1.5 bg-green-600 hover:bg-green-700">Search</Button>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button variant="outline" className="border-green-600 text-green-600 hover:bg-green-50">
                View Specialties <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </div>
          </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-white/80 text-sm">Hospitals</p>
                    </div>
                    <div className="text-center">
