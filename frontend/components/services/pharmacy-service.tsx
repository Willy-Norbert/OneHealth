      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white p-4 rounded-xl shadow-lg flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm">{t("pharmacy.overlay.delivery.title")}</h4>
                    <p className="text-gray-500 text-xs">{t("pharmacy.overlay.delivery.subtitle")}</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-4 left-4 bg-white p-4 rounded-xl shadow-lg flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm">{t("pharmacy.overlay.reminders.title")}</h4>
                    <p className="text-gray-500 text-xs">{t("pharmacy.overlay.reminders.subtitle")}</p>
                  </div>
                </div>
                ...
                <div className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white p-4 rounded-xl shadow-lg flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm">{t("pharmacy.overlay.payment.title")}</h4>
                    <p className="text-gray-500 text-xs">{t("pharmacy.overlay.payment.subtitle")}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">{t("pharmacy.title")}</h2>
            <p className="text-gray-600 mb-8">{t("pharmacy.description")}</p>
            ...
            <div className="bg-white rounded-xl p-6 mb-8">
              <h3 className="font-bold text-gray-900 mb-4">{t("pharmacy.partners.title")}</h3>
