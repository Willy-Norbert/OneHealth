    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="order-2 lg:order-1">
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8">
              <h3 className="font-bold text-gray-900 mb-4">{t("specialties.title")}</h3>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-12">
          <h3 className="text-2xl font-bold text-center text-gray-900 mb-8">{t("partners.title")}</h3>
        ...
        <div className="text-center bg-blue-600 text-white rounded-2xl p-12">
          ...
          <Link href="/teleconsultation/book">
            <Button className="bg-white text-blue-600 hover:bg-gray-100 text-lg px-8 py-3">
              {t("cta.button")} <Video className="ml-2 h-5 w-5" />
            </Button>
          </Link>
        </div>
      </div>
