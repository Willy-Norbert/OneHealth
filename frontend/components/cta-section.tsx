        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold leading-tight">
              {t("cta.title", "Download the ONE HEALTHLINE CONNECT App Today")}
            </h2>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              <Button className="bg-white text-blue-900 hover:bg-white/90 h-14 px-6">
                <Download className="mr-2 h-5 w-5" /> {t("cta.download_ios", "Download for iOS")}
              </Button>
              <Button variant="outline" className="border-white text-green-700 hover:bg-white/90 h-14 px-6">
                <Download className="mr-2 h-5 w-5" /> {t("cta.download_android", "Download for Android")}
              </Button>
            </div>
          </div>
