...
import { useLanguage } from '@/contexts/LanguageContext'; // or your i18n lib
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              {t("medicalDepartments.title", "Medical")} <span className="text-green-600">{t("medicalDepartments.highlight", "Departments")}</span> & {t("medicalDepartments.subtitle", "Specialties")}
            </h1>
