...
export default function FeaturedDepartments() {
  ...
  // Department IDs to icons and colors (keep these here)
  ...
  // Departments keys — fetch name, description, services from translations
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">{t("departments1.featured_title")}</h2>
          <p className="text-gray-600">{t("departments1.featured_description")}</p>
        </div>
          ...
          {featuredDepartments.map((dept, index) => (
            ...
            >
              ...
              <div className={index % 2 === 1 ? "order-2 lg:order-1" : ""}>
                ...
                <div className="mb-6">
                  <h4 className="font-medium text-gray-900 mb-3">{t("departments1.services_offered") || "Services Offered:"}</h4>
