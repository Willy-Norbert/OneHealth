...
import { useLanguage } from "@/contexts/LanguageContext" // Adjust import path if needed
    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900">{t("contact.title", "Contact Us")}</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h3 className="text-xl font-bold text-gray-900 mb-6">{t("contact.form.title", "Send us a message")}</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 mt-1">{t("contact.info.location.address", "KG 123 St, Kigali, Rwanda")}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 mt-1">{t("contact.info.phone.main", "+250 788 123 456")}</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 mt-1">{t("contact.info.email.main", "info@healthlinerwanda.com")}</p>
                  </div>
                </div>
              </div>
            </div>
