  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">Manage your patients and consultations</p>
      </div>
        ...
        <HealthCard className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">Teleconsultations</p>
            </div>
          </div>
        </HealthCard>
        ...
        <HealthCard className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">Prescriptions</p>
            </div>
          </div>
        </HealthCard>
      </div>
      ...
      {/* Today's Schedule */}
      <HealthCard className="p-6">
        <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Today's Schedule</h3>
        <div className="space-y-4">
          <div className="flex items-center p-4 bg-brand-50 dark:bg-brand-500/10 rounded-lg border border-brand-200 dark:border-brand-500/20">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">General Consultation</p>
            </div>
          ...
          <div className="flex items-center p-4 bg-blue-light-50 dark:bg-blue-light-500/10 rounded-lg border border-blue-light-200 dark:border-blue-light-500/20">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Teleconsultation</p>
            </div>
          ...
          <div className="flex items-center p-4 bg-gray-50 dark:bg-white/5 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Follow-up Consultation</p>
            </div>
            <span className="px-2 py-1 bg-success-100 text-success-700 dark:bg-success-500/20 dark:text-success-400 text-xs rounded-full">
              Confirmed
            </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <HealthCard className="p-6 hover:shadow-theme-lg transition-shadow cursor-pointer">
          ...
          <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-white">Patient Records</h3>
          <p className="text-gray-600 dark:text-gray-400 text-sm">View and manage patient medical records</p>
        </HealthCard>

        <HealthCard className="p-6 hover:shadow-theme-lg transition-shadow cursor-pointer">
          <FileText className="h-8 w-8 text-warning-500 mb-4" />
          <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-white">Prescriptions</h3>
          <p className="text-gray-600 dark:text-gray-400 text-sm">Create and manage digital prescriptions</p>
        </HealthCard>

        <HealthCard className="p-6 hover:shadow-theme-lg transition-shadow cursor-pointer">
          <Activity className="h-8 w-8 text-brand-500 mb-4" />
          <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-white">Analytics</h3>
          <p className="text-gray-600 dark:text-gray-400 text-sm">View consultation statistics and insights</p>
        </HealthCard>
      </div>
    </div>
  );
