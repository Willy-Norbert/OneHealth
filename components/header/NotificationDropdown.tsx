  ...
  return (
    <div className="relative">
      ...
      >
        ...
        >
          <span className="absolute inline-flex w-full h-full bg-orange-400 rounded-full opacity-75 animate-ping dark:bg-orange-500"></span>
        </span>
        <svg
              ...
              >
                <span className="relative block w-10 h-10 rounded-full overflow-hidden">
                  <Image
                    width={40}
                    height={40}
                    src={`/images/user/rwanda-user-0${i}.jpg`}
                    alt={`User ${i}`}
                    className="w-full h-full object-cover rounded-full"
                  />
                  <span className={`absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full border-[1.5px] border-white ${i === 4 ? "bg-error-500 dark:border-gray-900" : "bg-success-500 dark:border-gray-900"}`}></span>
                </span>
                <span className="block">
                  <span className="mb-1.5 block text-sm text-gray-500 dark:text-gray-400">
                    <span className="font-medium text-gray-800 dark:text-white/90">User {i}</span>{" "}
                    action description <span className="font-medium text-gray-800 dark:text-white/90">Hospital</span>
                  </span>
